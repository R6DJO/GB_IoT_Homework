...
flash: $(BUILD_DIR)/$(TARGET).elf
	"/home/r6djo/stm32/openocd/bin/openocd" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"/home/r6djo/stm32/openocd/bin/openocd" -f ./openocd.cfg -c "init; reset halt; stm32f1x mass_erase 0; exit"
